...
function LocationAR() {
    ...
    return (
        <div className={style.locationContainer}>
            <p data-aos="fade-up" className={style.locationTitle}>أهلاً</p>
            <p data-aos="fade-up" className={style.locationPara}>
            بندعوكم تشاركونا يوم فرحنا في مسجد الشرطة بالتجمع الخامس، وهنكون مبسوطين بوجودكم معانا
            </p>
            <div data-aos="fade-up" className={style.locationBox}>
                <div>
                    <p className={style.address}>مسجد الشرطة - روف 1 <br/> القاهرة الجديدة</p>
                </div>
